var GroupQuestionAdapter = new Class({
	...
	mergeGroupQuestionParent: function(mergeData){
		this.mergeGroupQuestionTemplate({questionCode: mergeData.parentQuestionCode,text: mergeData.label,displaySectionName: mergeData.displaySectionName,skipToId: mergeData.skipToId});
	},
